...
function createDefaultBookPages() {
    ...
    const contents = [
        ...
        'Chúc mừng sinh nhật Huệ Iu của tui! 🎂',
        'Chúc bé tuổi mới luôn vui vẻ và hạnh phúc! ✨',
        'Ngày càng nhiều niềm vui và thành công! 🌟',
        'Những kỷ niệm đẹp sẽ luôn ở bên em! 💫',
        'Cảm ơn em đã luôn ở bên anh! ❤️',
        'Yêu bé nhìu lắm 🎁'
    ];
...
function initializeDefaultSettings() {
    window.settings = {
        music: '/gift_universe_love_v2.vercel.app/style/nhac.mp3',
        countdown: 3,
        matrixText: 'HAPPYBIRTHDAY',
        matrixColor1: '#ff69b4',
        matrixColor2: '#ff1493',
        sequence: 'HAPPY|BIRTHDAY|HUE|IU|❤',
        sequenceColor: '#ff69b4',
        gift: './gif/Cat Love GIF by KIKI.gif',
        enableBook: true,
        enableHeart: true,
